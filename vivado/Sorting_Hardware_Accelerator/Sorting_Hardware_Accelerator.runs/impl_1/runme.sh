...
HD_PWD='C:/Users/simon/Documents/GitHub/sorting_hardware_accelerator/vivado/Sorting_Hardware_Accelerator/Sorting_Hardware_Accelerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SortingCell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SortingCell.tcl -notrace
