...
HD_PWD='C:/Users/simon/Documents/GitHub/sorting_hardware_accelerator/vivado/Sorting_Hardware_Accelerator/Sorting_Hardware_Accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SortingCell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SortingCell.tcl
